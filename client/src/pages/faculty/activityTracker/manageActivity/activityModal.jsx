...
export default function CreateActivityModal({ open, handleClose }) {
  ...
  const validateForm = () => {
    ...
    if (!publishingDepartment)
      newErrors.publishingDepartment = "Publishing Department is required.";
    ...
    if (!linkorlocation.trim())
      newErrors.linkorlocation = "Location or Link is required.";
    ...
    if (activity_type === "Sessions" && !specific_rollno.trim()) {
      newErrors.specific_rollno =
        "Student roll numbers are required for Sessions.";
    }
  ...
  const handleSubmit = async (event) => {
    ...
    const isForAllStudents =
      year_type === "All Years" && target_dept === "All Departments";
      ...
      >
          ...
          <section className="mb-6 sm:mb-8">
            ...
            <div className="mt-4 sm:mt-6">
              ...
              <DepartmentDropdown
                ...
                onChange={(e) => {
                  setPublishingDepartment(e.target.value);
                  clearError("publishingDepartment");
                }}
                placeholder="Select publishing department"
                error={errors.publishingDepartment}
            ...
            {activity_type === "Sessions" && (
              <div className="mt-4 sm:mt-6">
                <label
                  htmlFor="session_with"
                  className="block text-sm font-medium text-gray-600 mb-1"
                >
                  With whom is the Session? *
                </label>
                <input
                  type="text"
                  id="session_with"
          ...
          <section className="mb-6 sm:mb-8">
            ...
            <div className="mt-4 sm:mt-6">
              ...
              <input
                ...
                onChange={(e) => {
                  setLinkOrLocation(e.target.value);
                  clearError("linkorlocation");
                }}
              ...
              {activity_type === "Sessions" ? (
                <div className="mt-4 sm:mt-6">
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      setSpecificRollno(e.target.value);
                ...
                <>
                  <p className="text-xs text-gray-500 mb-4">
                    Select who can view and respond to this activity.
                  </p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-end gap-3 p-4 sm:p-6 border-t bg-slate-50">
          <button
            type="button"
            onClick={handleClose}
            className="w-full sm:w-auto px-4 py-2.5 text-sm font-medium text-gray-700 bg-white border rounded-lg shadow-sm hover:bg-gray-50"
          >
            Cancel
          </button>
          <button
            type="submit"
            form="activity-form"
            className="w-full sm:w-auto flex items-center justify-center gap-2 px-4 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-semibold rounded-lg shadow-md"
          >
            <Eye size={18} />
