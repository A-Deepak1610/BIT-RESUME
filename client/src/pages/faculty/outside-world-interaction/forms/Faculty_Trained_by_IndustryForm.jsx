...
export default function Faculty_Trained_by_IndustryForm() {
    ...
    const financialAssistanceOptions = ["Choose an option", "Self", "Management", "NA"];
    const typeOfApprovalOptions = ["Choose an option", "Apex", "Principal", "Dean"];
    ...
    const validate = () => {
        ...
        if (!formData.specialLabsInvolved || formData.specialLabsInvolved === "Choose an option") {
        ...
        if (!formData.trainer1Designation) newErrors.trainer1Designation = "Trainer 1 Designation is required";
        if (formData.typeOfApproval === "Apex" && !formData.apexApprovalNo) {
            newErrors.apexApprovalNo = "Apex approval number is required";
        }
        if (formData.trainer2Applicable === "yes" && !formData.trainer2Designation) {
    ...
    const handleSubmit = async (e) => {
        ...
        if (validate()) {
            try {
                ...
                const response = await axios.post(`${import.meta.env.VITE_API_URL}api/faculty/trainedByIndustryPost`, data, {
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                    <form onSubmit={handleSubmit} className="p-6 md:p-8 space-y-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            {formData.specialLabsInvolved === "yes" && (
                                <div>
                                    ...
                                    />
                                    {errors.specialLab && <p className="mt-1 text-sm text-red-600">{errors.specialLab}</p>}
                                </div>
                            )}
                        </div>

                        {/* Training Program Details */}
                        <h3 className="text-lg font-medium text-gray-900 border-b pb-2">Training Program Information</h3>

                        <div>
                            <label htmlFor="trainingProgramName" className="block text-sm font-medium text-gray-700 mb-1">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div>
                                <label htmlFor="financialAssistance" className="block text-sm font-medium text-gray-700 mb-1">
                            ...
                            <div>
                                <label htmlFor="amountIncurred" className="block text-sm font-medium text-gray-700 mb-1">
                            ...
                            <div>
                                <label htmlFor="typeOfApproval" className="block text-sm font-medium text-gray-700 mb-1">
                                    Type of Approval
                                </label>
                                <select
                                    name="typeOfApproval"
                        ...
                        {formData.typeOfApproval === "Apex" && (
                            <div>
                                <label htmlFor="apexApprovalNo" className="block text-sm font-medium text-gray-700 mb-1">
                                ...
                                />
                                {errors.apexApprovalNo && <p className="mt-1 text-sm text-red-600">{errors.apexApprovalNo}</p>}
                            </div>
                        )}

                        {/* Industry Details */}
                        <h3 className="text-lg font-medium text-gray-900 border-b pb-2">Industry Information</h3>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label htmlFor="domainArea" className="block text-sm font-medium text-gray-700 mb-1">
                            ...
                            <div>
                                <label htmlFor="typeOfIndustry" className="block text-sm font-medium text-gray-700 mb-1">
                        ...
                        {formData.typeOfIndustry === "Others" && (
                            <div>
                                <label htmlFor="othersSpecify" className="block text-sm font-medium text-gray-700 mb-1">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label htmlFor="modeOfTraining" className="block text-sm font-medium text-gray-700 mb-1">
                                    Mode of Training
                                </label>
                                <select
                                    name="modeOfTraining"
                        ...
                        <div>
                            <label htmlFor="industryWebsite" className="block text-sm font-medium text-gray-700 mb-1">
                                Industry Website
                            </label>
                            <input
                                type="url"
                        ...
                        {/* Trainer 1 Details */}
                        <h3 className="text-lg font-medium text-gray-900 border-b pb-2">Trainer 1 Details</h3>

                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label htmlFor="trainer1Name" className="block text-sm font-medium text-gray-700 mb-1">
                                    Trainer 1 Name
                                </label>
                                <input
                                    type="text"
                            ...
                            <div>
                                <label htmlFor="trainer1Designation" className="block text-sm font-medium text-gray-700 mb-1">
                                ...
                                />
                                {errors.trainer1Designation && <p className="mt-1 text-sm text-red-600">{errors.trainer1Designation}</p>}
                            </div>
                        </div>

                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label htmlFor="trainer1Email" className="block text-sm font-medium text-gray-700 mb-1">
                                    Trainer 1 Email ID
                                </label>
                                <input
                                    type="email"
                            ...
                            <div>
                                <label htmlFor="trainer1Phone" className="block text-sm font-medium text-gray-700 mb-1">
                        ...
                        {/* Trainer 2 Details */}
                        <h3 className="text-lg font-medium text-gray-900 border-b pb-2">Trainer 2 Details (Optional)</h3>

                        <div>
                            <label htmlFor="trainer2Applicable" className="block text-sm font-medium text-gray-700 mb-1">
                        ...
                        {formData.trainer2Applicable === "yes" && (
                            <>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        <label htmlFor="trainer2Name" className="block text-sm font-medium text-gray-700 mb-1">
                                            Trainer 2 Name
                                        </label>
                                        <input
                                            type="text"
                                    ...
                                    <div>
                                        <label htmlFor="trainer2Designation" className="block text-sm font-medium text-gray-700 mb-1">
                                        ...
                                        <input
                                            ...
                                            placeholder="Enter Designation"
                                        />
                                        {errors.trainer2Designation && <p className="mt-1 text-sm text-red-600">{errors.trainer2Designation}</p>}
                                    </div>
                                </div>

                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        <label htmlFor="trainer2Email" className="block text-sm font-medium text-gray-700 mb-1">
                                            Trainer 2 Email ID
                                        </label>
                                        <input
                                            type="email"
                                    ...
                                    <div>
                                        <label htmlFor="trainer2Phone" className="block text-sm font-medium text-gray-700 mb-1">
                        ...
                        <div>
                            ...
                            <div
                                className={`mt-1 flex flex-col items-center justify-center w-full h-32 px-6 pt-5 pb-6 border-2 ${errors.proofDocument ? 'border-red-500' : dragActive ? 'border-indigo-500 bg-indigo-50' : 'border-gray-300'
                            ...
                            >
                                <div className="space-y-1 text-center">
                                    ...
                                    <div className="flex text-sm text-gray-600">
                                        <label htmlFor="proof-upload" className="relative cursor-pointer rounded-md font-medium text-indigo-600 hover:text-indigo-500 focus-within:outline-none">
                                            <span>Upload a file</span>
                                            <input id="proof-upload" name="proofDocument" type="file" className="sr-only" onChange={handleFileChange} />
                                        </label>
                            ...
                            {formData.proofDocument && (
                                <div className="mt-2 flex items-center text-sm text-gray-600 bg-gray-50 p-2 rounded-md border border-gray-200">
                                    ...
                                    <span className="font-medium mr-2 truncate">{formData.proofDocument.name}</span>
                        ...
                        {/* Verification Status */}
                        <div>
                            <label htmlFor="owiVerification" className="block text-sm font-medium text-gray-700 mb-1">
                                OWI Verification
                            </label>
                            <select
