  ...
  const handleSubmit = async (e) => {
    ...
    if (validate()) {
      try {
        ...
        if (formData.eContentType === "Other") {
          data.append("otherEContentType", formData.otherEContentType);
        }
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
          <form onSubmit={handleSubmit} className="p-6 md:p-8 space-y-8">
            ...
            {/* Special Lab Dropdown - shown when specialLabsInvolved is "yes" */}
                ...
                {formData.eContentType === "Other" && (
                  <div className="mt-3">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className={`block w-full px-3 py-2 border ${errors.otherEContentType ? "border-red-500" : "border-gray-300"} rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm`}
