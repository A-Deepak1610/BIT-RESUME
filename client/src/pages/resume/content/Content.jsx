      ...
      <div className="w-full max-w-[1800px] flex flex-col">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center">
          ...
          <div className="flex flex-row lg:flex-col w-full lg:w-[12%] justify-around h-auto lg:h-[32vh] mt-2 lg:my-0 lg:mx-2">
            ...
            <div className="h-20 shadow-md rounded-lg flex flex-col justify-center items-center bg-white w-1/3 lg:w-full mx-1 lg:mx-0 transition-transform hover:scale-105">
              <div className="flex items-center">
