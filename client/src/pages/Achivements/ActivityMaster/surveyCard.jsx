...
const SurveyCard = ({ survey }) => {
  ...
  const isButtonDisabled = survey.Status === "completed" || survey.Status === "Missed";

  return (
    <div className="bg-white rounded-xl shadow-lg p-5 sm:p-6 w-full flex flex-col transitvion-transform   overflow-hidden">
